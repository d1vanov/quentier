#ifndef LIB_QUTE_NOTE_EXCEPTION_I_QUTE_NOTE_EXCEPTION_H
#define LIB_QUTE_NOTE_EXCEPTION_I_QUTE_NOTE_EXCEPTION_H
...
#endif // LIB_QUTE_NOTE_EXCEPTION_I_QUTE_NOTE_EXCEPTION_H
