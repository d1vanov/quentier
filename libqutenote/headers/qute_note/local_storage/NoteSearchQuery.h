#ifndef __LIB_QUTE_NOTE__LOCAL_STORAGE__NOTE_SEARCH_QUERY_H
#define __LIB_QUTE_NOTE__LOCAL_STORAGE__NOTE_SEARCH_QUERY_H
...
#endif // __LIB_QUTE_NOTE__LOCAL_STORAGE__NOTE_SEARCH_QUERY_H
