#ifndef LIB_QUTE_NOTE_LOCAL_STORAGE_NOTE_SEARCH_QUERY_H
#define LIB_QUTE_NOTE_LOCAL_STORAGE_NOTE_SEARCH_QUERY_H
...
#endif // LIB_QUTE_NOTE_LOCAL_STORAGE_NOTE_SEARCH_QUERY_H
