#ifndef LIB_QUTE_NOTE_TYPES_SHARED_NOTEBOOK_WRAPPER_H
#define LIB_QUTE_NOTE_TYPES_SHARED_NOTEBOOK_WRAPPER_H
...
#endif // LIB_QUTE_NOTE_TYPES_SHARED_NOTEBOOK_WRAPPER_H
