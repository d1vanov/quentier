#ifndef LIB_QUTE_NOTE_TYPES_SHARED_NOTEBOOK_ADAPTER_H
#define LIB_QUTE_NOTE_TYPES_SHARED_NOTEBOOK_ADAPTER_H
...
#endif // LIB_QUTE_NOTE_TYPES_SHARED_NOTEBOOK_ADAPTER_H
