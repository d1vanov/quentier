#ifndef LIB_QUTE_NOTE_TYPES_I_LOCAL_STORAGE_DATA_ELEMENT_H
#define LIB_QUTE_NOTE_TYPES_I_LOCAL_STORAGE_DATA_ELEMENT_H
...
#endif // LIB_QUTE_NOTE_TYPES_I_LOCAL_STORAGE_DATA_ELEMENT_H
