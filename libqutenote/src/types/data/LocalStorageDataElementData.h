#ifndef __LIB_QUTE_NOTE__TYPES__DATA__LOCAL_STORAGE_DATA_ELEMENT_DATA_H
#define __LIB_QUTE_NOTE__TYPES__DATA__LOCAL_STORAGE_DATA_ELEMENT_DATA_H
...
#endif // __LIB_QUTE_NOTE__TYPES__DATA__LOCAL_STORAGE_DATA_ELEMENT_DATA_H
