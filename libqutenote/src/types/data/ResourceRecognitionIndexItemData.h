#ifndef LIB_QUTE_NOTE_TYPES_DATA_RESOURCE_RECOGNITION_INDEX_ITEM_DATA_H
#define LIB_QUTE_NOTE_TYPES_DATA_RESOURCE_RECOGNITION_INDEX_ITEM_DATA_H
...
#endif // LIB_QUTE_NOTE_TYPES_DATA_RESOURCE_RECOGNITION_INDEX_ITEM_DATA_H
