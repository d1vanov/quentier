#ifndef __LIB_QUTE_NOTE__SYNCHRONIZATION__REMOTE_TO_LOCAL_SYNCHRONIZATION_MANAGER_H
...
#endif // __LIB_QUTE_NOTE__SYNCHRONIZATION__REMOTE_TO_LOCAL_SYNCHRONIZATION_MANAGER_H
