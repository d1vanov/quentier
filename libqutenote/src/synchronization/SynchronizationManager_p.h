#ifndef __LIB_QUTE_NOTE__SYNCHRONIZATION__SYNCHRONIZATION_MANAGER_PRIVATE_H
#define __LIB_QUTE_NOTE__SYNCHRONIZATION__SYNCHRONIZATION_MANAGER_PRIVATE_H
...
#endif // __LIB_QUTE_NOTE__SYNCHRONIZATION__SYNCHRONIZATION_MANAGER_PRIVATE_H
