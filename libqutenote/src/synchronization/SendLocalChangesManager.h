#ifndef LIB_QUTE_NOTE_SYNCHRONIZATION_SEND_LOCAL_CHANGES_MANAGER_H
#define LIB_QUTE_NOTE_SYNCHRONIZATION_SEND_LOCAL_CHANGES_MANAGER_H
...
#endif // LIB_QUTE_NOTE_SYNCHRONIZATION_SEND_LOCAL_CHANGES_MANAGER_H
