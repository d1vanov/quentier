#ifndef LIB_QUTE_NOTE_TESTS_LOCAL_STORAGE_CACHE_ASYNC_TESTER_H
#define LIB_QUTE_NOTE_TESTS_LOCAL_STORAGE_CACHE_ASYNC_TESTER_H
...
#endif // LIB_QUTE_NOTE_TESTS_LOCAL_STORAGE_CACHE_ASYNC_TESTER_H
