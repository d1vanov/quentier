#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_UNDO_STACK_REPLACE_ALL_UNDO_COMMAND_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_UNDO_STACK_REPLACE_ALL_UNDO_COMMAND_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_UNDO_STACK_REPLACE_ALL_UNDO_COMMAND_H
