#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_NOTE_EDITOR_PLUGIN_FACTORY_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_NOTE_EDITOR_PLUGIN_FACTORY_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_NOTE_EDITOR_PLUGIN_FACTORY_H
