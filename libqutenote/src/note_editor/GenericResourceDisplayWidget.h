#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_GENERIC_RESOURCE_DISPLAY_WIDGET_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_GENERIC_RESOURCE_DISPLAY_WIDGET_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_GENERIC_RESOURCE_DISPLAY_WIDGET_H
