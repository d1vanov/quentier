#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_RESOURCE_FILES_STORAGE_MANAGER_P_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_RESOURCE_FILES_STORAGE_MANAGER_P_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_RESOURCE_FILES_STORAGE_MANAGER_P_H
