#ifndef __QUTE_NOTE__CORE__NOTE_EDITOR__RESOURCE_FILES_STORAGE_MANAGER_PRIVATE_H
#define __QUTE_NOTE__CORE__NOTE_EDITOR__RESOURCE_FILES_STORAGE_MANAGER_PRIVATE_H
...
#endif // __QUTE_NOTE__CORE__NOTE_EDITOR__RESOURCE_FILES_STORAGE_MANAGER_PRIVATE_H
