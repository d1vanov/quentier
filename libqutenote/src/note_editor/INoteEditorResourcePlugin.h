#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_I_NOTE_EDITOR_RESOURCE_PLUGIN_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_I_NOTE_EDITOR_RESOURCE_PLUGIN_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_I_NOTE_EDITOR_RESOURCE_PLUGIN_H
