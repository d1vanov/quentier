#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_DECRYPTION_DIALOG_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_DECRYPTION_DIALOG_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_DECRYPTION_DIALOG_H
