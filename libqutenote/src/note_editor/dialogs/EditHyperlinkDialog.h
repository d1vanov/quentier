#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_EDIT_HYPERLINK_DIALOG_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_EDIT_HYPERLINK_DIALOG_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_EDIT_HYPERLINK_DIALOG_H
