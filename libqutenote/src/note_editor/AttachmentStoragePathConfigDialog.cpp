    ...
    m_pUI(new Ui::AttachmentStoragePathConfigDialog)
{
    ...
    m_pUI->infoLabel->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">" +
                              ...
                              QObject::tr("needs some folder to store copies of attachments. Unfortunately, "
...
{
    QString path = getExistingFolderDialog(this, QObject::tr("Choose folder to store attachments"),
