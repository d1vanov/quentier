#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_JAVA_SCRIPT_IN_ORDER_EXECUTOR_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_JAVA_SCRIPT_IN_ORDER_EXECUTOR_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_JAVA_SCRIPT_IN_ORDER_EXECUTOR_H
