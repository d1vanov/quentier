#ifndef LIB_QUTE_NOTE_NOTE_EDITOR_DELEGATES_RENAME_RESOURCE_DELEGATE_H
#define LIB_QUTE_NOTE_NOTE_EDITOR_DELEGATES_RENAME_RESOURCE_DELEGATE_H
...
#endif // LIB_QUTE_NOTE_NOTE_EDITOR_DELEGATES_RENAME_RESOURCE_DELEGATE_H
