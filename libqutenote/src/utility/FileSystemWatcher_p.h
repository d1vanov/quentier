#ifndef LIB_QUTE_NOTE_UTILITY_FILE_SYSTEM_WATCHER_PRIVATE_H
#define LIB_QUTE_NOTE_UTILITY_FILE_SYSTEM_WATCHER_PRIVATE_H
...
#endif // LIB_QUTE_NOTE_UTILITY_FILE_SYSTEM_WATCHER_PRIVATE_H
