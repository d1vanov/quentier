#ifndef LIB_QUTE_NOTE_UTILITY_ENCRYPTION_MANAGER_P_H
#define LIB_QUTE_NOTE_UTILITY_ENCRYPTION_MANAGER_P_H
...
#endif // LIB_QUTE_NOTE_UTILITY_ENCRYPTION_MANAGER_P_H
