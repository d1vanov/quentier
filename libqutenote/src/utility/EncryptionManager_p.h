#ifndef __LIB_QUTE_NOTE__UTILITY__ENCRYPTION_MANAGER_P_H
#define __LIB_QUTE_NOTE__UTILITY__ENCRYPTION_MANAGER_P_H
...
#endif // __LIB_QUTE_NOTE__UTILITY__ENCRYPTION_MANAGER_P_H
