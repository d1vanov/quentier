#ifndef QUTE_NOTE_TESTS_MODEL_TEST_FAVORITES_MODEL_TEST_HELPER_H
#define QUTE_NOTE_TESTS_MODEL_TEST_FAVORITES_MODEL_TEST_HELPER_H
...
#endif // QUTE_NOTE_TESTS_MODEL_TEST_FAVORITES_MODEL_TEST_HELPER_H
