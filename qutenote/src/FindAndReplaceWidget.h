#ifndef QUTE_NOTE_NOTE_EDITOR_FIND_AND_REPLACE_WIDGET_H
#define QUTE_NOTE_NOTE_EDITOR_FIND_AND_REPLACE_WIDGET_H
...
#endif // QUTE_NOTE_NOTE_EDITOR_FIND_AND_REPLACE_WIDGET_H
