...
elseif(${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
  ...
  find_path(LIBCPP_DIR NAMES libc++.so libc++.so.1.0 libc++.dylib HINTS ENV CMAKE_LIBRARY_PATH OPTIONAL)
  if(LIBCPP_DIR)
    if(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
      include_directories(BEFORE SYSTEM "${LIBCPP_DIR}/../include/c++/v1")
    endif()
    find_library(LIBCPP NAMES libc++.so libc++.so.1.0 libc++.dylib HINTS LIBCPP_DIR OPTIONAL)
    if(LIBCPP)
