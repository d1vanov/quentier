function(CreateQuentierBundle)
  ...
  # Find base names of ssl and crypto libraries files
  get_filename_component(OPENSSL_SSL_LIBRARY_BASE_NAME ${OPENSSL_SSL_LIBRARY} NAME_WE)
  get_filename_component(OPENSSL_CRYPTO_LIBRARY_BASE_NAME ${OPENSSL_CRYPTO_LIBRARY} NAME_WE)
  ...
  if(WIN32)
    ...
    install(CODE "
            ...
            foreach(OPENSSL_ROOT_DIR \${OPENSSL_POTENTIAL_ROOT_DIRS})
              message(STATUS \"Checking whether file exists: \${OPENSSL_ROOT_DIR}/bin/${OPENSSL_SSL_LIBRARY_BASE_NAME}.dll\")
              if(EXISTS \"\${OPENSSL_ROOT_DIR}/bin/${OPENSSL_SSL_LIBRARY_BASE_NAME}.dll\")
                message(STATUS \"Exists, copying\")
                file(COPY \"\${OPENSSL_ROOT_DIR}/bin/${OPENSSL_SSL_LIBRARY_BASE_NAME}.dll\" DESTINATION \"${CMAKE_INSTALL_BINDIR}\")
              elseif(EXISTS \"\${OPENSSL_ROOT_DIR}/${OPENSSL_SSL_LIBRARY_BASE_NAME}.dll\")
                message(STATUS \"Another file exists: \${OPENSSL_ROOT_DIR}/${OPENSSL_SSL_LIBRARY_BASE_NAME}.dll, copying\")
                file(COPY \"\${OPENSSL_ROOT_DIR}/${OPENSSL_SSL_LIBRARY_BASE_NAME}.dll\" DESTINATION \"${CMAKE_INSTALL_BINDIR}\")
              endif()
              message(STATUS \"Checking whether file exists: \${OPENSSL_ROOT_DIR}/${OPENSSL_CRYPTO_LIBRARY_BASE_NAME}.dll\")
              if(EXISTS \"\${OPENSSL_ROOT_DIR}/${OPENSSL_CRYPTO_LIBRARY_BASE_NAME}.dll\")
                message(STATUS \"Exists, copying\")
                file(COPY \"\${OPENSSL_ROOT_DIR}/${OPENSSL_CRYPTO_LIBRARY_BASE_NAME}.dll\" DESTINATION \"${CMAKE_INSTALL_BINDIR}\")
              endif()
            endforeach()
            " COMPONENT Runtime)
