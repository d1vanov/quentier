  ...
  if(WIN32)
    if(USE_QT5)
      ...
      install(CODE "
              ...
              fixup_bundle(${APPS}   \"\"   \"${DIRS}\" IGNORE_ITEM \"quentier_minidump_stackwalk.exe;libgcc_s_dw2-1.dll\")
              " COMPONENT Runtime)
    else()
      install(CODE "
              include(DeployQt4)
              include(InstallRequiredSystemLibraries)
              fixup_qt4_executable(${APPS} \"qsqlite\" \"\" \"${DIRS}\" IGNORE_ITEM \"quentier_minidump_stackwalk.exe;libgcc_s_dw2-1.dll\")
              " COMPONENT Runtime)
    endif(USE_QT5)
