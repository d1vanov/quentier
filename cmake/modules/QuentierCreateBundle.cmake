  ...
  if(WIN32)
    ...
    install(CODE "
            ...
            foreach(OPENSSL_ROOT_DIR \${OPENSSL_POTENTIAL_ROOT_DIRS})
              ...
              if(EXISTS \"\${OPENSSL_ROOT_DIR}/libssl-1_1.dll\")
                message(STATUS \"Exists, copying\")
              ...
              if(EXISTS \"\${OPENSSL_ROOT_DIR}/libcrypto-1_1.dll\")
                message(STATUS \"Exists, copying\")
              ...
              if(EXISTS \"\${OPENSSL_ROOT_DIR}/libssl-1_1-x64.dll\")
                message(STATUS \"Exists, copying\")
              ...
              if(EXISTS \"\${OPENSSL_ROOT_DIR}/libcrypto-1_1-x64.dll\")
                message(STATUS \"Exists, copying\")
                file(COPY \"\${OPENSSL_ROOT_DIR}/libcrypto-1_1.dll-x64\" DESTINATION \"${CMAKE_INSTALL_BINDIR}\")
              endif()
            endforeach()
            " COMPONENT Runtime)
