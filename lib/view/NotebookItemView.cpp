...
{
    QNDEBUG("NotebookItemView::selectAllNotebooksRootItem");
...
{
    QNDEBUG("NotebookItemView::setSelectedNotebookToNoteFiltersManager: "
        << notebookLocalUid);
...
{
    QNDEBUG("NotebookItemView::clearNotebooksFromNoteFiltersManager");
