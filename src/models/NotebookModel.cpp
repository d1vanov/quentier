...
{
    QNTRACE(QStringLiteral("NotebookModel::incrementNoteCountForNotebook: ") << notebookLocalUid);
...
{
    QNTRACE(QStringLiteral("NotebookModel::decrementNoteCountForNotebook: ") << notebookLocalUid);
